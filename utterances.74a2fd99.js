parcelRequire = function(e) {
  ...
  function $() {
      var e = C(location.search.substr(1)),
          r = null,
          i = null;
      if ("issue-term" in e) {
      ...
      return e.token && (c.value = e.token), {
          owner: t[1],
          repo: t[2],
          issueTerm: r,
          issueNumber: i,
  ...
  o.deparam = C, o.param = t;
  var _ = /^([\w-_]+)\/([\w-_.]+)$/i;
  var k = {};
  var s = "https://api.utteranc.es";
  var aa = k && k.__awaiter || function(e, r, t, n) {
      ...
      ba = k && k.__generator || function(e, r) {
          var t, n, o, a, $ = {
              label: 0,
              sent: function() {
                  if (1 & o[0]) throw o[1];
                      ...
                      for (; $;) try {
                          ...
                          switch (n = 0, o && (a = [2 & a[0], o.value]), a[0]) {
                              ...
                              default:
                                  ...
                                  if (o && $.label < o[2]) {
                                      $.label = o[2], $.ops.push(a);
                                      break
                                  }
                                  o[2] && $.ops.pop(), $.trys.pop();
                                  continue;
                          }
                          a = r.call(e, $)
                      } catch (i) {
  ...
  function D() {
      return aa(this, void 0, Promise, function() {
          ...
          return ba(this, function(n) {
              switch (n.label) {
                  case 0:
                      return c.value ? [2, c.value] : (e = s + "/token", [4, fetch(e, {
                          method: "POST",
                          mode: "cors",
                          credentials: "include"
                      })]);
  ...
  k.token = c, k.getLoginUrl = r, k.loadToken = D;
  var a = $();
  var b = {};
  ...
  var da = b && b.__awaiter || function(n, e, t, r) {
          return new(t || (t = Promise))(function($, o) {
              ...
              function i(n) {
                  var e;
                  n.done ? $(n.value) : (e = n.value, e instanceof t ? e : new t(function(n) {
                      n(e)
                  })).then(a, s)
              }
      ...
      ea = b && b.__generator || function(n, e) {
          var t, r, $, o, a = {
              label: 0,
              sent: function() {
                  if (1 & $[0]) throw $[1];
          ...
          function s(o) {
              return function(s) {
                  return function(o) {
                      if (t) throw new TypeError("Generator is already executing.");
                      for (; a;) try {
                          if (t = 1, r && ($ = 2 & o[0] ? r.return : o[0] ? r.throw || (($ = r.return) && $.call(r), 0) : r.next) && !($ = $.call(r, o[1])).done) return $;
                          switch (r = 0, $ && (o = [2 & o[0], $.value]), o[0]) {
                              case 0:
                              case 1:
                                  $ = o;
                                  break;
      ...
      E = "https://api.github.com/",
      F = "application/vnd.github.VERSION.html+json",
      fa = "application/vnd.github.VERSION.html",
      m = "application/vnd.github.squirrel-girl-preview",
      q = 25;
  b.PAGE_SIZE = q;
  var i, j, p = ["+1", "-1", "laugh", "hooray", "confused", "heart", "rocket", "eyes"];
  b.reactionTypes = p;
  var G = "master";
  ...
  function h(n, e) {
      ...
      var t = new Request(E + n, e);
      return t.headers.set("Accept", m), /^search\//.test(n) || null === c.value || t.headers.set("Authorization", "token " + c.value), t
  }
  b.setRepoContext = H;
  var I = {
      standard: {
  ...
  function ga(n) {
      var e = n.headers.get("X-RateLimit-Limit"),
          t = n.headers.get("X-RateLimit-Remaining"),
          r = n.headers.get("X-RateLimit-Reset"),
          $ = /\/search\//.test(n.url),
          o = $ ? I.search : I.standard;
      if (o.limit = +e, o.remaining = +t, o.reset = +r, 403 === n.status && 0 === o.remaining) {
          var a = new Date(0);
  ...
  function ha(n) {
      ...
      if (null === e) return 0;
      var t = /\?page=([2-9][0-9]*)>; rel="next"/.exec(e);
      return null === t ? 0 : +t[1]
  }

  function f(n) {
      return fetch(n).then(function(e) {
          return 401 === e.status && (c.value = null), 403 === e.status && e.json().then(function(n) {
              "Resource not accessible by integration" === n.message && window.dispatchEvent(new CustomEvent("not-installed"))
          }), ga(e), "GET" === n.method && -1 !== [401, 403].indexOf(e.status) && n.headers.has("Authorization") ? (n.headers.delete("Authorization"), f(n)) : e
      })
  }

  function J(n, e) {
      void 0 === e && (e = !1);
      var t = h("repos/" + i + "/" + j + "/contents/" + n + "?ref=" + G);
      return e && t.headers.set("accept", fa), f(t).then(function(t) {
          if (404 === t.status) throw new Error("Repo \"" + i + "/" + j + "\" does not have a file named \"" + n + "\" in the \"" + G + "\" branch.");
          if (!t.ok) throw new Error("Error fetching " + n + ".");
          return e ? t.text() : t.json()
      }).then(function(n) {
          if (e) return n;
          var t = n.content,
              r = ca(t);
  ...
  function K(n) {
      var e = "\"" + n + "\" type:issue in:title repo:" + i + "/" + j;
      return f(h("search/issues?q=" + encodeURIComponent(e) + "&sort=created&order=asc")).then(function(n) {
          if (!n.ok) throw new Error("Error fetching issue via search.");
          return n.json()
      }).then(function(t) {
          if (0 === t.total_count) return null;
          t.total_count > 1 && console.warn("Multiple issues match \"" + e + "\"."), n = n.toLowerCase();
          for (var r = 0, $ = t.items; r < $.length; r++) {
              var o = $[r];
              if (-1 !== o.title.toLowerCase().indexOf(n)) return o
          }
          return console.warn("Issue search results do not contain an issue with title matching \"" + n + "\". Using first result."), t.items[0]
      })
  }

  function L(n) {
      return f(h("repos/" + i + "/" + j + "/issues/" + n)).then(function(n) {
  ...
  function ia(n, e) {
      var t = h("repos/" + i + "/" + j + "/issues/" + n + "/comments?page=" + e + "&per_page=" + q),
          r = F + "," + m;
      return t.headers.set("Accept", r), t
  }

  function v(n, e) {
      return f(ia(n, e)).then(function(n) {
  ...
  function M() {
      return null === c.value ? Promise.resolve(null) : f(h("user")).then(function(n) {
          return n.ok ? n.json() : null
      })
  }

  function N(n, e, t, r, $) {
      var o = s + "/repos/" + i + "/" + j + "/issues" + ($ ? "?label=" + encodeURIComponent($) : ""),
          a = new Request(o, {
              method: "POST",
              body: JSON.stringify({
                  title: n,
      ...
      return a.headers.set("Accept", m), a.headers.set("Authorization", "token " + c.value), fetch(a).then(function(n) {
  ...
  function O(n, e) {
      var t = h("repos/" + i + "/" + j + "/issues/" + n + "/comments", {
              method: "POST",
              body: JSON.stringify({
                  body: e
              })
          ...
          r = F + "," + m;
      return t.headers.set("Accept", r), f(t).then(function(n) {
  ...
  function P(n, e) {
      return da(this, void 0, void 0, function() {
          ...
          return ea(this, function(i) {
              switch (i.label) {
                  case 0:
                      return n = n.replace(E, ""), t = JSON.stringify({
                          content: e
                      }), (r = h(n, {
                          method: "POST",
                          body: t
                      })).headers.set("Accept", m), [4, f(r)];
                  case 1:
                  ...
                  case 3:
                      a = null, i.label = 4;
                  case 4:
                      if (o = a, 201 === $.status) return [2, {
                          reaction: o,
                          deleted: !1
                      }];
                      if (200 !== $.status) throw new Error("expected \"201 reaction created\" or \"200 reaction already exists\"");
                      return (s = h("reactions/" + o.id, {
                          method: "DELETE"
                      })).headers.set("Accept", m), [4, f(s)];
                  case 5:
                      return i.sent(), [2, {
                          reaction: o,
                          deleted: !0
  ...
  b.readRelNext = ha, b.loadJsonFile = J, b.loadIssueByTerm = K, b.loadIssueByNumber = L, b.loadCommentsPage = v, b.loadUser = M, b.createIssue = N, b.postComment = O, b.toggleReaction = P, b.renderMarkdown = Q;
  var n = [1e3, "second", 6e4, "minute", 36e5, "hour", 864e5, "day", 6048e5, "week", 23328e5, "month"],
      ja = {
          month: "short",
          day: "numeric",
          year: "numeric"
  ...
  function ka(r, e) {
      ...
      for (var o = 0; o + 2 < n.length && 1.1 * $ > n[o + 2];) o += 2;
      var t = n[o],
          a = n[o + 1],
          h = Math.round($ / t);
      return h > 3 && o === n.length - 2 ? "on " + e.toLocaleDateString(void 0, ja) : 1 === h ? ("hour" === a ? "an" : "a") + " " + a + " ago" : h + " " + a + "s ago"
  }
  var la;

  function ma(e) {
      la = e, addEventListener("resize", d), addEventListener("load", d)
  }
  var na = -1;
  ...
  var e = {};
  var qa = e && e.__awaiter || function(e, t, n, r) {
      ...
      ra = e && e.__generator || function(e, t) {
          var n, r, a, o, i = {
              label: 0,
              sent: function() {
                  if (1 & a[0]) throw a[1];
  ...
  function S(e) {
      ...
      addEventListener("click", function(n) {
          return qa(t, void 0, void 0, function() {
              var t, r, a, o, i, s, c, f, l, $, u;
              return ra(this, function(p) {
                  switch (p.label) {
                      case 0:
                          return (t = n.target instanceof HTMLElement && n.target.closest("button")) && t.hasAttribute("reaction") ? (n.preventDefault(), e ? (t.disabled = !0, (r = t.closest("details")) && (r.open = !1), a = t.formAction, o = t.value, [4, P(a, o)]) : [2]) : [2];
                      case 1:
                          for (i = p.sent().deleted, s = "button[reaction][formaction=\"" + a + "\"][value=\"" + o + "\"],[reaction-count][reaction-url=\"" + a + "\"]", c = Array.from(document.querySelectorAll(s)), f = i ? -1 : 1, l = 0, $ = c; l < $.length; l++)(u = $[l]).setAttribute("reaction-count", (parseInt(u.getAttribute("reaction-count"), 10) + f).toString());
                          return t.disabled = !1, d(), [2];
                  }
              })
          })
      }, !0)
  ...
  var sa = "?v=3&s=88",
      ...
      ua = function() {
          function e(e, r) {
              ...
              this.element.innerHTML = "\n      <a class=\"avatar\" href=\"" + t.html_url + "\" target=\"_blank\" tabindex=\"-1\">\n        <img alt=\"@" + t.login + "\" height=\"44\" width=\"44\"\n              src=\"" + t.avatar_url + sa + "\">\n      </a>\n      <div class=\"comment\">\n        <header class=\"comment-header\">\n          <span class=\"comment-meta\">\n            <a class=\"text-link\" href=\"" + t.html_url + "\" target=\"_blank\"><strong>" + t.login + "</strong></a>\n            commented\n            <a class=\"text-link\" href=\"" + n + "\" target=\"_blank\">" + ka(Date.now(), new Date(o)) + "</a>\n          </span>\n          <div class=\"comment-actions\">\n            " + (c ? "<span class=\"author-association-badge\">" + c + "</span>" : "") + "\n            " + (r ? z(e.reactions.url, "right") : A("right")) + "\n          </div>\n        </header>\n        <div class=\"markdown-body markdown-body-scrollable\">\n          " + a + "\n        </div>\n        <div class=\"comment-footer\" reaction-count=\"" + l + "\" reaction-url=\"" + s.url + "\">\n          <form class=\"reaction-list BtnGroup\" action=\"javascript:\">\n            " + p.map(function(e) {
                  return y(s.url, e, !r, s[e])
              }).join("") + "\n          </form>\n          " + (r ? z(e.reactions.url, "center") : A("center")) + "\n        </div>\n      </div>";
              var m = this.element.querySelector(".markdown-body"),
                  $ = m.querySelector(".email-hidden-toggle a");
              if ($) {
                  var u = m.querySelector(".email-hidden-reply");
                  $.onclick = function(e) {
                      e.preventDefault(), u.classList.toggle("expanded")
                  }
              }
              U(m)
          }
  ...
  var va = function() {
      ...
      return e.prototype.setUser = function(e) {
          ...
          this.issue = e, e ? (this.count = e.comments, this.countAnchor.href = e.html_url, this.renderCount()) : this.countAnchor.removeAttribute("href")
      }, e.prototype.insertComment = function(e, t) {
          var n = new ua(e, this.user ? this.user.login : null),
              i = this.timeline.findIndex(function(t) {
                  return t.comment.id >= e.id
              });
          if (-1 === i) this.timeline.push(n), this.element.insertBefore(n.element, this.marker);
          else {
              var s = this.timeline[i],
                  r = s.comment.id === e.id;
              this.element.insertBefore(n.element, s.element), this.timeline.splice(i, r ? 1 : 0, n), r && s.element.remove()
          }
          t && (this.count++, this.renderCount()), d()
          ...
          return r.onclick = n, {
              setBusy: function() {
                  o.textContent = "Loading...", r.disabled = !0
              },
              remove: function() {
                  r.onclick = null, s.remove()
              }
          }
  ...
  function W() {
      return V || (V = J("utterances.json").then(function(r) {
          return Array.isArray(r.origins) || (r.origins = []), r
      }, function() {
          return {
              origins: [a.origin]
          }
  ...
  var X = l && l.__assign || function() {
      ...
      wa = l && l.__awaiter || function(t, e, n, a) {
      ...
      xa = l && l.__generator || function(t, e) {
          var n, a, r, i, s = {
              label: 0,
              sent: function() {
                  if (1 & r[0]) throw r[1];
      ...
      ya = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 14 16\" version=\"1.1\"><path fill=\"rgb(179,179,179)\" fill-rule=\"evenodd\" d=\"M8 10.5L9 14H5l1-3.5L5.25 9h3.5L8 10.5zM10 6H4L2 7h10l-2-1zM9 2L7 3 5 2 4 5h6L9 2zm4.03 7.75L10 9l1 2-2 3h3.22c.45 0 .86-.31.97-.75l.56-2.28c.14-.53-.19-1.08-.72-1.22zM4 9l-3.03.75c-.53.14-.86.69-.72 1.22l.56 2.28c.11.44.52.75.97.75H5l-2-3 1-2z\"></path></svg>",
      za = "data:image/svg+xml;base64," + btoa(ya),
      B = "Nothing to preview",
      Y = function() {
          function t(t, e) {
              var n = this;
              this.user = t, this.submit = e, this.submitting = !1, this.renderTimeout = 0, this.handleInput = function() {
                  W();
                  var t = n.textarea.value,
                      e = /^\s*$/.test(t);
                  n.submitButton.disabled = e, n.textarea.scrollHeight < 450 && n.textarea.offsetHeight < n.textarea.scrollHeight && (n.textarea.style.height = n.textarea.scrollHeight + "px", d()), clearTimeout(n.renderTimeout), e ? n.preview.textContent = B : (n.preview.textContent = "Loading preview...", n.renderTimeout = setTimeout(function() {
                  ...
                  return wa(n, void 0, void 0, function() {
                      return xa(this, function(e) {
                          switch (e.label) {
                              case 0:
                                  return t.preventDefault(), this.submitting ? [2] : (this.submitting = !0, this.textarea.disabled = !0, this.submitButton.disabled = !0, [4, this.submit(this.textarea.value).catch(function() {
                                      return 0
                                  })]);
                              case 1:
                                  return e.sent(), this.submitting = !1, this.textarea.disabled = !this.user, this.textarea.value = "", this.submitButton.disabled = !1, this.handleClick(X(X({}, t), {
                                      target: this.form.querySelector(".tabnav-tab.tab-write")
                                  })), this.preview.textContent = B, [2];
                          }
                      })
                  })
                  ...
                  if (e instanceof HTMLButtonElement && e.classList.contains("tabnav-tab") && "true" !== e.getAttribute("aria-selected")) {
                      n.form.querySelector(".tabnav-tab[aria-selected=\"true\"]").setAttribute("aria-selected", "false"), e.setAttribute("aria-selected", "true");
  ...
  function Aa(t) {
      var e = function t() {
          removeEventListener("mousemove", d), removeEventListener("mouseup", t)
      };
      t.addEventListener("mousedown", function() {
          addEventListener("mousemove", d), addEventListener("mouseup", e)
      })
  }
  l.NewCommentComponent = Y;
  ...
  var w = g && g.__awaiter || function(e, r, t, n) {
      ...
      x = g && g.__generator || function(e, r) {
          var t, n, o, s, i = {
              label: 0,
              sent: function() {
                  if (1 & o[0]) throw o[1];
  ...
  function Ca() {
      return null !== a.issueNumber ? L(a.issueNumber) : K(a.issueTerm)
  }

  function Da() {
      return w(this, void 0, void 0, function() {
          var e, r, t, n, o, s, i = this;
          return x(this, function(u) {
              switch (u.label) {
                  case 0:
                      return [4, D()];
                  case 1:
                      return u.sent(), [4, Promise.all([Ca(), M(), Ba(a.theme, a.origin)])];
                  case 2:
                      return e = u.sent(), r = e[0], t = e[1], ma(a.origin), n = new va(t, r), document.body.appendChild(n.element), r && r.comments > 0 && Ea(r, n), d(), r && r.locked ? [2] : (S(!!t), o = function(e) {
                              ...
                              return x(this, function(o) {
                                  switch (o.label) {
                                      case 0:
                                          return [4, Z()];
                                      case 1:
                                          return o.sent(), r ? [3, 3] : [4, N(a.issueTerm, a.url, a.title, a.description, a.label)];
                                      case 2:
                                          r = o.sent(), n.setIssue(r), o.label = 3;
                                      case 3:
                                          return [4, O(r.number, e)];
                                      case 4:
                                          return t = o.sent(), n.insertComment(t, !0), s.clear(), [2];
                                  }
                              })
                          })
                      }, s = new Y(t, o), n.element.appendChild(s.element), [2]);
              }
          })
      })
  }
          ...
          return x(this, function(l) {
              switch (l.label) {
                  case 0:
                      ...
                      }, n = Math.ceil(e.comments / q), o = [v(e.number, 1)], n > 1 && o.push(v(e.number, n)), n > 2 && e.comments % q < 3 && o.push(v(e.number, n - 1)), [4, Promise.all(o)];
                  case 1:
                      for (s = l.sent(), i = 0, u = s; i < u.length; i++) a = u[i], t(a);
                      return $ = n - o.length, f = 2, (p = function(n) {
                          if (0 !== $) var o = n.pop(),
                              s = r.insertPageLoader(o, $ * q, function() {
                                  return w(c, void 0, void 0, function() {
                                      var r;
                                      return x(this, function(n) {
                                          switch (n.label) {
                                              case 0:
                                                  return s.setBusy(), [4, v(e.number, f)];
                                              case 1:
                                                  return r = n.sent(), s.remove(), t(r), $--, f++, p(r), [2];
                                          }
                                      })
                                  })
                              })
          ...
          return x(this, function(o) {
              switch (o.label) {
                  case 0:
                      return [4, W()];
                  case 1:
                      if (e = o.sent().origins, r = a.origin, t = a.owner, n = a.repo, -1 !== e.indexOf(r)) return [2];
                      throw document.querySelector(".timeline").lastElementChild.insertAdjacentHTML("beforebegin", "\n  <div class=\"flash flash-error flash-not-installed\">\n    Error: <code>" + r + "</code> is not permitted to post to <code>" + t + "/" + n + "</code>.\n    Confirm this is the correct repo for this site's comments. If you own this repo,\n    <a href=\"https://github.com/" + t + "/" + n + "/edit/master/utterances.json\" target=\"_top\">\n      <strong>update the utterances.json</strong>\n    </a>\n    to include <code>" + r + "</code> in the list of origins.<br/><br/>\n    Suggested configuration:<br/>\n    <pre><code>" + JSON.stringify({
                          origins: [r]
                      }, null, 2) + "</code></pre>\n  </div>"), d(), new Error("Origin not permitted.");
              }
          })
      })
  }
  H(a), Da(), addEventListener("not-installed", function e() {
